...
const Jobdetail = ({navigation}) => {
  ...
  console.log('token id value  ===>>', token);

  const handleSaveJob = async () => {
    const data = JSON.stringify({action: 'save'});
    const config = {
      method: 'post',
      url: `https://jobbookbackend.azurewebsites.net/api/v1/jobbook/talent/home/toggleSaveJob/${jobId}`,
      headers: {
    ...
    <ImageBackground
      ...
      <SafeAreaView style={styles.container}>
          ...
          <View style={styles.main}>
            <View style={styles.uxCon}>
              <View
                ...
                <TouchableOpacity style={styles.icon} onPress={handleSaveJob}>
                  <Image
                    source={ICON}
                    style={{width: '100%', height: '100%'}}
                    resizeMode="center"
              ...
              <View
                ...
                <View style={styles.location}>
                  ...
                  <Text style={styles.loctxt}>{jobDetailsData.location}</Text>
                </View>
                <View style={styles.exp}>
                  <Entypo name="graduation-cap" color={'#fff'} size={15} />
                  <Text style={styles.loctxt}>{jobDetailsData.experience}</Text>
                </View>
                <View style={styles.time}>
                  <Ionicons name="time-outline" size={15} color={'#fff'} />
                  <Text style={styles.loctxt}>{jobDetailsData.jobType}</Text>
                </View>
              </View>
              ...
              <View style={styles.btmm}>
                <View style={{flexDirection: 'row'}}>
                  ...
                  <Text style={styles.txt1}>{jobDetailsData.postedAgo}</Text>
                </View>

                <View>
                  <Text style={styles.txt}>{jobDetailsData.salary}</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View style={styles.btnbox}>
          <TouchableOpacity style={styles.btn} onPress={handleSaveJob}>
            <Text style={styles.btntxt}>Save</Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={styles.btnn}
            onPress={() => navigation.navigate('applyjobform' , {jobId})}>

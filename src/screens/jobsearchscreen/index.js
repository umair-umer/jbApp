    ...
    <ImageBackground
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.screnbuttactive}
            onPress={() => navigation.navigate('closedscreen')}>
            <Text style={styles.screbuttonactive}>Closed</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{paddingRight: width * 0.25, marginVertical: height * 0.02}}>
        ...
        <View style={styles.inpmain}>
          ...
          <TouchableOpacity
            style={styles.fltrbtn}
            onPress={() => navigation.navigate('specialscreen')}>
                ...
                <ImageBackground
                  ...
                  <View
                    ...
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text style={styles.postduration}>
                        Posted {calculateDaysAgo(job.createdAt)} days ago
                      </Text>
                    </View>
                    <View>
